...
public class ValidacoesStringTests
{
    ...
    public void DeveContemAPalavraQualquerNoTexto()
    {
        ...
        // Act
         var resultado = _validacoes.ContemCaractere(texto.ToUpper(), textoProcurado.ToUpper());
    ...
    public void TextoDeveTerminarComAPalavraProcurado()
    {
        ...
        // Act
        var resultado = _validacoes.TextoTerminaCom(texto.ToUpper(), textoProcurado.ToUpper());
